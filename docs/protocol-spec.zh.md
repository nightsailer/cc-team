> **参考文档** — Claude Code Multi-Agent Team 协议机制参考
> 来源：https://github.com/nightsailer/claude-code-team-architecture.git
> 本文档作为 cc-team 项目的协议实现参考，描述了 Claude Code 原生多 Agent 团队协作的完整架构和协议细节。
